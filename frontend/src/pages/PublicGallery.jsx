...
export const PublicGallery = ({ user, gallery = [], articles = [], investorReviews = [], conferences = [], onNavigateToLogin }) => {
  ...
  useEffect(() => {
    ...
    } else if (location.pathname === '/' || location.pathname === '/gallery' || location.pathname === '/login' || location.pathname === '/register') {
            ...
            return (
              ...
              >
                ...
                <div className="p-6 pt-0 space-y-4">
                  ...
                  <button
                    onClick={() => handleOpenPaper(article || { id: item.featured_article_id, title: item.title, abstract: item.description, student_name: 'Lead Student Researcher', category: 'Technology', tier: 'Platinum' })}
